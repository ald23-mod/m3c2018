...
program hw2main
  ...
  implicit none
  integer, parameter :: n=784,dfull=70000, dtest=10000
  integer:: d=100
  ...
  call sgd(fvec0,n,0,d,0.1d0,fvec) !requires snmodel subroutine to be operational
